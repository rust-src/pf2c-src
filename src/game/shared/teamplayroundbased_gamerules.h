...
#ifdef PF2_DLL
	// Reads from scripts/soldiermemorial.txt
	void	CreateSoldierStatue( void );

	// Handling spawning new entities through %s_map_ents.txt
	void	MapEntsSpawnAll( void );
#endif
