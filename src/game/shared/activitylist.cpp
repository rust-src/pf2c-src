...
//HL2MP
	...
	// Multiplayer - ScoutShotgun
	REGISTER_SHARED_ACTIVITY(ACT_MP_STAND_SCOUTSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MP_CROUCH_SCOUTSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MP_RUN_SCOUTSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MP_WALK_SCOUTSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MP_AIRWALK_SCOUTSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MP_CROUCHWALK_SCOUTSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MP_JUMP_SCOUTSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MP_JUMP_START_SCOUTSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MP_JUMP_FLOAT_SCOUTSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MP_JUMP_LAND_SCOUTSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MP_SWIM_SCOUTSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MP_DEPLOYED_SCOUTSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MP_SWIM_DEPLOYED_SCOUTSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MP_CROUCHWALK_DEPLOYED_SCOUTSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MP_CROUCH_DEPLOYED_IDLE_SCOUTSHOTGUN);

	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_STAND_SCOUTSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_STAND_SCOUTSHOTGUN_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_CROUCH_SCOUTSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_CROUCH_SCOUTSHOTGUN_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_SWIM_SCOUTSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_AIRWALK_SCOUTSHOTGUN);

	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_STAND_SCOUTSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_STAND_SCOUTSHOTGUN_LOOP);
	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_STAND_SCOUTSHOTGUN_END);
	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_CROUCH_SCOUTSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_CROUCH_SCOUTSHOTGUN_LOOP);
	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_CROUCH_SCOUTSHOTGUN_END);
	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_SWIM_SCOUTSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_SWIM_SCOUTSHOTGUN_LOOP);
	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_SWIM_SCOUTSHOTGUN_END);
	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_AIRWALK_SCOUTSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_AIRWALK_SCOUTSHOTGUN_LOOP);
	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_AIRWALK_SCOUTSHOTGUN_END);

	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_STAND_SCOUTSHOTGUN_2);
	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_STAND_SCOUTSHOTGUN_LOOP_2);
	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_STAND_SCOUTSHOTGUN_END_2);
	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_CROUCH_SCOUTSHOTGUN_2);
	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_CROUCH_SCOUTSHOTGUN_LOOP_2);
	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_CROUCH_SCOUTSHOTGUN_END_2);
	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_SWIM_SCOUTSHOTGUN_2);
	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_SWIM_SCOUTSHOTGUN_LOOP_2);
	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_SWIM_SCOUTSHOTGUN_END_2);
	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_AIRWALK_SCOUTSHOTGUN_2);
	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_AIRWALK_SCOUTSHOTGUN_LOOP_2);
	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_AIRWALK_SCOUTSHOTGUN_END_2);
