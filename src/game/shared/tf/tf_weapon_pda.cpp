...
IMPLEMENT_NETWORKCLASS_ALIASED( TFWeaponPDA_Demo, DT_TFWeaponPDA_Demo )

BEGIN_NETWORK_TABLE( CTFWeaponPDA_Demo, DT_TFWeaponPDA_Demo )
END_NETWORK_TABLE()

BEGIN_PREDICTION_DATA( CTFWeaponPDA_Demo )
END_PREDICTION_DATA()

//LINK_ENTITY_TO_CLASS( tf_weapon_pda_demo, CTFWeaponPDA_Demo );
//PRECACHE_WEAPON_REGISTER( tf_weapon_pda_demo );
