...
protected:
	...
	static CTFBaseProjectile *Create( const char *pszClassname, const Vector &vecOrigin, 
		const QAngle &vecAngles, CBaseEntity *pOwner, float flVelocity, short iProjModelIndex, CBaseEntity *pScorer = NULL, bool bCritical = false );
...
public:
	...
	virtual bool	IsNail() { return false; }
