...
public:
	...
	virtual CBaseEntity *FireProjectile( CTFPlayer *pPlayer, bool consumeAmmo = true );
	...
	CBaseEntity *FireFlameRocket(CTFPlayer *pPlayer);
	void FireNail( CTFPlayer *pPlayer, int iSpecificNail );
