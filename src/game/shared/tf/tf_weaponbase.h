...
class CTFWeaponBase : public CBaseCombatWeapon
{
	...
	static acttable_t m_acttableScoutShotgun[];
...
public:
	...
	CTraceFilterIgnoreTeammates( const IHandleEntity *passentity, int collisionGroup, int iIgnoreTeam, bool bEntitiesOnly = false )
		: CTraceFilterSimple( passentity, collisionGroup ), m_iIgnoreTeam( iIgnoreTeam ), m_bEntitiesOnly( bEntitiesOnly )
	{
	}
