...
void CTFWeaponBase::Precache()
{
	...
	{
		KeyValues *pViewModels = pTFInfo->m_pClassViewModelKV;
		for (KeyValues *kv = pViewModels->GetFirstSubKey(); kv; kv = kv->GetNextKey())
		{
			const char *sViewModelName = pViewModels->GetString(kv->GetString(), nullptr);
			if (sViewModelName)
				PrecacheModel( sViewModelName );
		}
	}*/
}
...
const char *CTFWeaponBase::GetViewModel( int iViewModel ) const
{
	...
	if (GetTFWpnData().m_pClassViewModelKV)
	{
		const char *pszViewModelName = GetTFWpnData().m_pClassViewModelKV->GetString( pTFPlayer->GetPlayerClass()->GetName(), nullptr );
		if (pszViewModelName)
		{
			return pszViewModelName;
		}
	}*/
...
bool CTFWeaponBase::Ready( void )
{
	...
	CBaseViewModel *pModel = pPlayer->GetViewModel();

	m_bLowered = false;	

	if (LookupSequence( "unholster" ) != -1)
	{
#ifdef GAME_DLL
		CDisablePredictionFiltering disabler;
#endif
		pModel->SetSequence( LookupSequence( "unholster" ) );
		pPlayer->m_flNextAttack = gpGlobals->curtime + (pModel->SequenceDuration());
	}
	else
	{
		pPlayer->m_flNextAttack = gpGlobals->curtime + 0.67f;
	}
...
bool CTFWeaponBase::Lower( void )
{
	...
	m_bLowered = true;
	if (LookupSequence( "holster" ) != -1)
	{
#ifdef GAME_DLL
		CDisablePredictionFiltering disabler;
#endif
		pModel->SetSequence( LookupSequence( "holster" ) );
		if (V_strcmp( pModel->GetSequenceName( pModel->GetSequence() ), "holster" ) != 0)
...
acttable_t CTFWeaponBase::m_acttableScoutShotgun[] =
{
	{ ACT_MP_STAND_IDLE, ACT_MP_STAND_SCOUTSHOTGUN, false },
	{ ACT_MP_CROUCH_IDLE, ACT_MP_CROUCH_SCOUTSHOTGUN, false },
	{ ACT_MP_DEPLOYED, ACT_MP_DEPLOYED_SCOUTSHOTGUN, false },
	{ ACT_MP_RUN, ACT_MP_RUN_SCOUTSHOTGUN, false },
	{ ACT_MP_WALK, ACT_MP_WALK_SCOUTSHOTGUN, false },
	{ ACT_MP_AIRWALK, ACT_MP_AIRWALK_SCOUTSHOTGUN, false },
	{ ACT_MP_CROUCHWALK, ACT_MP_CROUCHWALK_SCOUTSHOTGUN, false },
	{ ACT_MP_JUMP, ACT_MP_JUMP_SCOUTSHOTGUN, false },
	{ ACT_MP_JUMP_START, ACT_MP_JUMP_START_SCOUTSHOTGUN, false },
	{ ACT_MP_JUMP_FLOAT, ACT_MP_JUMP_FLOAT_SCOUTSHOTGUN, false },
	{ ACT_MP_JUMP_LAND, ACT_MP_JUMP_LAND_SCOUTSHOTGUN, false },
	{ ACT_MP_SWIM, ACT_MP_SWIM_SCOUTSHOTGUN, false },
	{ ACT_MP_SWIM_DEPLOYED, ACT_MP_SWIM_DEPLOYED_SCOUTSHOTGUN, false },

	{ ACT_MP_ATTACK_STAND_PRIMARYFIRE, ACT_MP_ATTACK_STAND_SCOUTSHOTGUN, false },
	{ ACT_MP_ATTACK_STAND_PRIMARYFIRE_DEPLOYED, ACT_MP_ATTACK_STAND_SCOUTSHOTGUN_DEPLOYED, false },
	{ ACT_MP_ATTACK_CROUCH_PRIMARYFIRE, ACT_MP_ATTACK_CROUCH_SCOUTSHOTGUN, false },
	{ ACT_MP_ATTACK_CROUCH_PRIMARYFIRE_DEPLOYED, ACT_MP_ATTACK_CROUCH_SCOUTSHOTGUN_DEPLOYED, false },
	{ ACT_MP_ATTACK_SWIM_PRIMARYFIRE, ACT_MP_ATTACK_SWIM_SCOUTSHOTGUN, false },
	{ ACT_MP_ATTACK_AIRWALK_PRIMARYFIRE, ACT_MP_ATTACK_AIRWALK_SCOUTSHOTGUN, false },

	{ ACT_MP_RELOAD_STAND, ACT_MP_RELOAD_STAND_SCOUTSHOTGUN, false },
	{ ACT_MP_RELOAD_STAND_LOOP, ACT_MP_RELOAD_STAND_SCOUTSHOTGUN_LOOP, false },
	{ ACT_MP_RELOAD_STAND_END, ACT_MP_RELOAD_STAND_SCOUTSHOTGUN_END, false },
	{ ACT_MP_RELOAD_CROUCH, ACT_MP_RELOAD_CROUCH_SCOUTSHOTGUN, false },
	{ ACT_MP_RELOAD_CROUCH_LOOP, ACT_MP_RELOAD_CROUCH_SCOUTSHOTGUN_LOOP, false },
	{ ACT_MP_RELOAD_CROUCH_END, ACT_MP_RELOAD_CROUCH_SCOUTSHOTGUN_END, false },
	{ ACT_MP_RELOAD_SWIM, ACT_MP_RELOAD_SWIM_SCOUTSHOTGUN, false },
	{ ACT_MP_RELOAD_SWIM_LOOP, ACT_MP_RELOAD_SWIM_SCOUTSHOTGUN_LOOP, false },
	{ ACT_MP_RELOAD_SWIM_END, ACT_MP_RELOAD_SWIM_SCOUTSHOTGUN_END, false },
	{ ACT_MP_RELOAD_AIRWALK, ACT_MP_RELOAD_AIRWALK_SCOUTSHOTGUN, false },
	{ ACT_MP_RELOAD_AIRWALK_LOOP, ACT_MP_RELOAD_AIRWALK_SCOUTSHOTGUN_LOOP, false },
	{ ACT_MP_RELOAD_AIRWALK_END, ACT_MP_RELOAD_AIRWALK_SCOUTSHOTGUN_END, false },

	{ ACT_MP_GESTURE_FLINCH, ACT_MP_GESTURE_FLINCH_SCOUTSHOTGUN, false },

	{ ACT_MP_GRENADE1_DRAW, ACT_MP_SCOUTSHOTGUN_GRENADE1_DRAW, false },
	{ ACT_MP_GRENADE1_IDLE, ACT_MP_SCOUTSHOTGUN_GRENADE1_IDLE, false },
	{ ACT_MP_GRENADE1_ATTACK, ACT_MP_SCOUTSHOTGUN_GRENADE1_ATTACK, false },
	{ ACT_MP_GRENADE2_DRAW, ACT_MP_SCOUTSHOTGUN_GRENADE2_DRAW, false },
	{ ACT_MP_GRENADE2_IDLE, ACT_MP_SCOUTSHOTGUN_GRENADE2_IDLE, false },
	{ ACT_MP_GRENADE2_ATTACK, ACT_MP_SCOUTSHOTGUN_GRENADE2_ATTACK, false },
	...
	{ ACT_MP_GESTURE_VC_HANDMOUTH, ACT_MP_GESTURE_VC_HANDMOUTH_SCOUTSHOTGUN, false },
	{ ACT_MP_GESTURE_VC_FINGERPOINT, ACT_MP_GESTURE_VC_FINGERPOINT_SCOUTSHOTGUN, false },
	{ ACT_MP_GESTURE_VC_FISTPUMP, ACT_MP_GESTURE_VC_FISTPUMP_SCOUTSHOTGUN, false },
	{ ACT_MP_GESTURE_VC_THUMBSUP, ACT_MP_GESTURE_VC_THUMBSUP_SCOUTSHOTGUN, false },
	{ ACT_MP_GESTURE_VC_NODYES, ACT_MP_GESTURE_VC_NODYES_SCOUTSHOTGUN, false },
	{ ACT_MP_GESTURE_VC_NODNO, ACT_MP_GESTURE_VC_NODNO_SCOUTSHOTGUN, false },
};
...
acttable_t *CTFWeaponBase::ActivityList( int &iActivityCount )
{
	...
	case TF_WPN_TYPE_SCOUTSHOTGUN:
		pTable = m_acttableScoutShotgun;
		iActivityCount = ARRAYSIZE(m_acttableScoutShotgun);
		break;
...
static ConVar	cl_bob("cl_bob", "0", FCVAR_CLIENTDLL | FCVAR_ARCHIVE);
