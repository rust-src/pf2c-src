...
// Client specific.
	...
	#define CTFWeaponPDA_Demo C_TFWeaponPDA_Demo
#endif
...
class CTFWeaponPDA_Demo : public CTFWeaponPDA
{
public:
	DECLARE_CLASS( CTFWeaponPDA_Demo, CTFWeaponPDA );
	DECLARE_NETWORKCLASS();
	DECLARE_PREDICTABLE();

	virtual const char *GetPanelName() { return ""; }
	virtual int		GetWeaponID( void ) const { return TF_WEAPON_PDA_DEMO; }
};
