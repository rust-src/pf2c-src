...
int g_aWeaponDamageTypes[] =
{
	...
	DMG_BULLET | DMG_USEDISTANCEMOD | DMG_NOCLOSEDISTANCEMOD | DMG_PREVENT_PHYSICS_FORCE,		// TF_WEAPON_SHOTGUN_MEDIC,
	...
	DMG_BUCKSHOT | DMG_USEDISTANCEMOD | DMG_USE_HITLOCATIONS | DMG_HALF_FALLOFF | DMG_CRITICAL | DMG_RADIUS_MAX | DMG_IGNITE | DMG_BLAST | DMG_NOCLOSEDISTANCEMOD | DMG_DISSOLVE,	// TF_WEAPON_SHOTGUN_Developer,
	DMG_BULLET | DMG_USEDISTANCEMOD,		// TF_WEAPON_SMG_MEDIC,
	DMG_CLUB,	//TF_WEAPON_MEDIKIT
	DMG_GENERIC, //TF_WEAPON_FLAG
	DMG_BURN,   //TF_WEAPON_BLOWTORCH
	DMG_CLUB,   //TF_WEAPON_MACHETE
