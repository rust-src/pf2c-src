...
#define CTFShotgun_Developer C_TFShotgun_Developer
#endif
...
// developer version. Different models, possibly different behaviour later on
class CTFShotgun_Developer : public CTFShotgun
{
public:
	DECLARE_CLASS(CTFShotgun_Developer, CTFShotgun);
	DECLARE_NETWORKCLASS();
	DECLARE_PREDICTABLE();



	virtual int		GetWeaponID(void) const { return TF_WEAPON_SHOTGUN_DEVELOPER; }
};
