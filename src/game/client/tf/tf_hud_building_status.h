...
// Purpose: 
//-----------------------------------------------------------------------------
class CBuildingStatusItem_Detpack : public CBuildingStatusItem
{
	DECLARE_CLASS_SIMPLE( CBuildingStatusItem_Detpack, CBuildingStatusItem );

public:
	CBuildingStatusItem_Detpack( Panel *parent );
};
...
//-----------------------------------------------------------------------------
// Purpose: Separate panels for demoman
//-----------------------------------------------------------------------------
class CHudBuildingStatusContainer_Demoman : public CHudBuildingStatusContainer
{
	DECLARE_CLASS_SIMPLE( CHudBuildingStatusContainer_Demoman, CHudBuildingStatusContainer );

public:
	CHudBuildingStatusContainer_Demoman( const char *pElementName );
