...
public:
	...
	void	SetType( MedicCallType_t iType ) { m_iType = iType; }
	static void AddMedicCaller( C_TFPlayer *pPlayer, float flDuration, Vector &vecOffset, MedicCallType_t iType );
