...
#include "tf_optionsmultiplayerpanel.h"
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CTFOptionsMultiplayerPanel::CTFOptionsMultiplayerPanel(vgui::Panel *parent, const char *panelName) : CTFDialogPanelBase(parent, panelName)
{
	Init();
}
...
// Purpose: Destructor
//-----------------------------------------------------------------------------
CTFOptionsMultiplayerPanel::~CTFOptionsMultiplayerPanel()
{
	delete m_pDescription;
}


bool CTFOptionsMultiplayerPanel::Init()
{
	BaseClass::Init();
...
void CTFOptionsMultiplayerPanel::ApplySchemeSettings(vgui::IScheme *pScheme)
{
	BaseClass::ApplySchemeSettings(pScheme);

	LoadControlSettings("resource/UI/main_menu/OptionsMultiplayerPanel.res");
}

void CTFOptionsMultiplayerPanel::OnCommand(const char* command)
{
	BaseClass::OnCommand(command);
}

void CTFOptionsMultiplayerPanel::OnKeyCodeTyped(KeyCode code)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTFOptionsMultiplayerPanel::GatherCurrentValues()
{
	if (!m_pDescription)
		return;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTFOptionsMultiplayerPanel::CreateControls()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTFOptionsMultiplayerPanel::DestroyControls()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTFOptionsMultiplayerPanel::SaveValues()
{
...
void CTFOptionsMultiplayerPanel::OnApplyChanges()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTFOptionsMultiplayerPanel::OnControlModified( void )
{
