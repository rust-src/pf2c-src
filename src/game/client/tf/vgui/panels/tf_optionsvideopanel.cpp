...
void CTFOptionsVideoPanel::CreateControls()
{
	...
	Label *pTitleVideo = new Label( this, "DescTextTitle", "#GameUI_Video" );
	...
	m_pFOVSlider = new CTFCvarSlider(this, "FOV", "#GameUI_FOV", MIN_FOV, MAX_FOV, "fov_desired");
