...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CTFMenuPanelBase::CTFMenuPanelBase( vgui::Panel* parent, const char *panelName ) : EditablePanel( NULL, panelName, vgui::scheme()->LoadSchemeFromFile( "Resource/ClientMenuScheme.res", "ClientScheme" ) )
{
	SetParent(parent);
	//SetScheme( "ClientMenuScheme" );
