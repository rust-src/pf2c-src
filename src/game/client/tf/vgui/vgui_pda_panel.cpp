...
class CPDAPanel_Demo : public CPDAPanel
{
	DECLARE_CLASS( CPDAPanel_Demo, CPDAPanel );

public:
	CPDAPanel_Demo( vgui::Panel *parent, const char *panelName );
};

DECLARE_VGUI_SCREEN_FACTORY( CPDAPanel_Demo, "pda_panel_demo" );

//-----------------------------------------------------------------------------
// Constructor: 
//-----------------------------------------------------------------------------
CPDAPanel_Demo::CPDAPanel_Demo( vgui::Panel *parent, const char *panelName )
	: CPDAPanel( parent, "CPDAPanel_Demo" )
{
}
