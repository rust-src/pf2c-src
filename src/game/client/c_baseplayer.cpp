...
// Marking this a cheat as it potentially can be abused
static ConVar	cl_first_person_uses_world_model ( "cl_first_person_uses_world_model", "0", FCVAR_CHEAT, "Causes the third person model to be drawn instead of the view model" );
