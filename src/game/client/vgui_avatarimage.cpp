...
void CAvatarImage::Paint( void )
{
	...
	if ( m_bValid )
	{
		...
		// hmmm yes the texture is definitely 90x90 not 128x128
		if (m_AvatarSize == k_EAvatarSize184x184)
			vgui::surface()->DrawTexturedRect( posX, posY, posX + m_avatarWide + 38, posY + m_avatarTall + 38 );
		else
