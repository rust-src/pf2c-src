...
public:
	...
	void SetupADFlagMode( bool adFlagMode );
	void UpdateADFlagMode( bool adFlagMode );
	void UpdateControlPointsNeedingFlags();
	
	void SetupADFlag( bool bEnabled );
	void HandleADFlag( void );
	bool FindADFlag( void );
...
private:
	...
	COutputEvent m_outputOnCPFlagEnabled;
	COutputEvent m_outputOnCPFlagDisabled;
