...
//===========================
	...
	ADD_ACTIVITY_TO_SR(ACT_MP_STAND_SCOUTSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MP_CROUCH_SCOUTSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MP_RUN_SCOUTSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MP_WALK_SCOUTSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MP_AIRWALK_SCOUTSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MP_CROUCHWALK_SCOUTSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MP_JUMP_SCOUTSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MP_JUMP_START_SCOUTSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MP_JUMP_FLOAT_SCOUTSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MP_JUMP_LAND_SCOUTSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MP_SWIM_SCOUTSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MP_DEPLOYED_SCOUTSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MP_SWIM_DEPLOYED_SCOUTSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MP_CROUCHWALK_DEPLOYED_SCOUTSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MP_CROUCH_DEPLOYED_IDLE_SCOUTSHOTGUN);


	ADD_ACTIVITY_TO_SR(ACT_MP_ATTACK_STAND_SCOUTSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MP_ATTACK_STAND_SCOUTSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MP_ATTACK_CROUCH_SCOUTSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MP_ATTACK_CROUCH_SCOUTSHOTGUN_DEPLOYED);
	ADD_ACTIVITY_TO_SR(ACT_MP_ATTACK_SWIM_SCOUTSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MP_ATTACK_AIRWALK_SCOUTSHOTGUN);

	ADD_ACTIVITY_TO_SR(ACT_MP_RELOAD_STAND_SCOUTSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MP_RELOAD_STAND_SCOUTSHOTGUN_LOOP);
	ADD_ACTIVITY_TO_SR(ACT_MP_RELOAD_STAND_SCOUTSHOTGUN_END);
	ADD_ACTIVITY_TO_SR(ACT_MP_RELOAD_CROUCH_SCOUTSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MP_RELOAD_CROUCH_SCOUTSHOTGUN_LOOP);
	ADD_ACTIVITY_TO_SR(ACT_MP_RELOAD_CROUCH_SCOUTSHOTGUN_END);
	ADD_ACTIVITY_TO_SR(ACT_MP_RELOAD_SWIM_SCOUTSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MP_RELOAD_SWIM_SCOUTSHOTGUN_LOOP);
	ADD_ACTIVITY_TO_SR(ACT_MP_RELOAD_SWIM_SCOUTSHOTGUN_END);
	ADD_ACTIVITY_TO_SR(ACT_MP_RELOAD_AIRWALK_SCOUTSHOTGUN);
	ADD_ACTIVITY_TO_SR(ACT_MP_RELOAD_AIRWALK_SCOUTSHOTGUN_LOOP);
	ADD_ACTIVITY_TO_SR(ACT_MP_RELOAD_AIRWALK_SCOUTSHOTGUN_END);

	ADD_ACTIVITY_TO_SR(ACT_MP_RELOAD_STAND_SCOUTSHOTGUN_2);
	ADD_ACTIVITY_TO_SR(ACT_MP_RELOAD_STAND_SCOUTSHOTGUN_LOOP_2);
	ADD_ACTIVITY_TO_SR(ACT_MP_RELOAD_STAND_SCOUTSHOTGUN_END_2);
	ADD_ACTIVITY_TO_SR(ACT_MP_RELOAD_CROUCH_SCOUTSHOTGUN_2);
	ADD_ACTIVITY_TO_SR(ACT_MP_RELOAD_CROUCH_SCOUTSHOTGUN_LOOP_2);
	ADD_ACTIVITY_TO_SR(ACT_MP_RELOAD_CROUCH_SCOUTSHOTGUN_END_2);
	ADD_ACTIVITY_TO_SR(ACT_MP_RELOAD_SWIM_SCOUTSHOTGUN_2);
	ADD_ACTIVITY_TO_SR(ACT_MP_RELOAD_SWIM_SCOUTSHOTGUN_LOOP_2);
	ADD_ACTIVITY_TO_SR(ACT_MP_RELOAD_SWIM_SCOUTSHOTGUN_END_2);
	ADD_ACTIVITY_TO_SR(ACT_MP_RELOAD_AIRWALK_SCOUTSHOTGUN_2);
	ADD_ACTIVITY_TO_SR(ACT_MP_RELOAD_AIRWALK_SCOUTSHOTGUN_LOOP_2);
	ADD_ACTIVITY_TO_SR(ACT_MP_RELOAD_AIRWALK_SCOUTSHOTGUN_END_2);
