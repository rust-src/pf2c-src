...
#define GRENADE_PACK_RESPAWN_TIME 25.0f
...
class CGrenadePack : public CAmmoPack
{
public:
	DECLARE_CLASS(CAmmoPackMedium, CAmmoPack);

	virtual const char* GetPowerupModel(void) { return "models/items/item_grenadepack.mdl"; }
