...
BEGIN_DATADESC( CTFTeamSpawn )
	...
	DEFINE_KEYFIELD( m_bSpawnArmor, FIELD_BOOLEAN, "SpawnArmor" ),
	DEFINE_KEYFIELD( m_bSpawnGrenades, FIELD_BOOLEAN, "SpawnGrenades" ),
	...
	DEFINE_INPUTFUNC( FIELD_BOOLEAN, "SetArmorSpawn", InputArmorSpawn ),
	DEFINE_INPUTFUNC( FIELD_BOOLEAN, "SetGrenadeSpawn", InputGrenadeSpawn ),
...
// Purpose:
//-----------------------------------------------------------------------------
void CTFTeamSpawn::InputArmorSpawn( inputdata_t& inputdata )
{
	m_bSpawnArmor = inputdata.value.Bool();
}

//-----------------------------------------------------------------------------
// Purpose:
//-----------------------------------------------------------------------------
void CTFTeamSpawn::InputGrenadeSpawn( inputdata_t& inputdata )
{
	m_bSpawnGrenades = inputdata.value.Bool();
}
