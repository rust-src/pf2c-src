...
BEGIN_DATADESC( CTeamControlPointRound )
	...
	DEFINE_KEYFIELD( m_iszAssociatedFlag, FIELD_STRING, "cpr_ad_flag" ),
...
bool CTeamControlPointRound::FindADFlag( void )
{
...
void CTeamControlPointRound::HandleADFlag( void )
{
...
void CTeamControlPointRound::SetupADFlag( bool bEnabled )
{
	if (!m_hAssociatedFlag)
		return;
